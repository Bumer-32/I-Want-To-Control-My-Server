...
object Constants {
    ...
    val CONFIG_FOLDER = "${System.getProperty(
        "user.dir",
    )}/$MOD_ID" // FabricLoader.getInstance().configDir.toString() // Temporary, idk why but FabricLoader works wrongly at jar https://github.com/Bumer-32/I-Want-To-Control-My-Server/issues/7
