...
<div class="tab disabled h-full" id={"settings_file|" + selfConfigSetting.selector_name} bind:this={tabContainer}>
    <div class="easy-view">
        <div class="easy-view-text flex flex-col justify-center items-center gap-[10px] absolute top-[50%] left-[50%] text-center">
    ...
    <div class="flex justify-center items-center h-full disabled">
        <!--suppress HtmlWrongAttributeValue -->
        <textarea class="w-[80%] h-[80%] resize-none bg-[var(--file-view-background-color)] text-[var(--file-view-text-color)] border-none rounded-[10px] text-[15px] p-[15px] focus:outline-none" spellcheck="false" wrap="off" bind:this={textArea}></textarea>
    </div>
</div>
