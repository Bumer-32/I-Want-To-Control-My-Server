...
<div class="bg-[var(--players-background-color)] flex justify-between rounded-[5px] gap-[10px] p-[5px]">
    <div class="flex flex-col">
        <img src="https://vzge.me/face/64/{player.username}.png" class="h-[64px] w-[64px] rounded-[10px]" alt="H"> <!--I tried to change UA as matched in service notice, but I can't do it in browser and I don't want to write request in ktor for this-->
    ...
    <div class="flex flex-col justify-between">
        ...
        <div class="flex flex-col gap-[5px]">
            <button class="bg-[var(--players-buttons-bg-color)] rounded-[5px] px-[4px]" on:click={() => {
