...
<div
        class="grid grid-rows-[minmax(100px, auto)] gap-[10px] rounded-[10px]"
        class:grid-cols-1={players.length === 1}
        class:grid-cols-2={players.length === 2}
        class:grid-cols-3={players.length >= 3}
>
